...
export default function SuccessScreenFlightsComponent({ routing }) {
  ...
  return (
    <div className="flex flex-col w-full items-center justify-center h-full mt-[10vh]">
      <div className=" flex flex-col items-center justify-center h-[40vh] rounded-xl w-[60vw] bg-white shadow-xl">
        <svg
        ...
        <h1 className="text-xl font-bold text-gray-800 mb-2 text-center">
          Flight Details Captured successfully! <br></br>Kindly wait for our
          team to revert back.
        </h1>
        {showMessage && (
          <a
